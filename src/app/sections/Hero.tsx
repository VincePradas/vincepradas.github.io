...
export default function Hero() {
  return (
    <section id="hero" className="text-sans">
      {/* Left */}
      <div className="lg:mt-0 mt-10 min-h-screen justify-center flex flex-col lg:flex-row items-center lg:justify-between px-6 lg:px-20 py-10 gap-10 text-sans">
